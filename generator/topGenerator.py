...
def generateTop():
	...
	for i in range(0, arraySize):
		...
		file.write("\tlogic [inputBits-1:0] mem_d_" + str(i) + "_writeData;\n")
		file.write("\tlogic [inputBits-1:0] mem_d_" + str(i) + "_readData;\n")
	...
	for i in range(0, arraySize):
		...
		file.write("\tassign mem_a_" + str(i) + "_writeData = S_AXIS_TDATA[" + str(0*arraySize+(i+1)) + "*inputBits-1:" + str(0*arraySize+i) + "*inputBits];\n")
		file.write("\tmem #(inputBits, arraySize) mem_a_" + str(i) + "(clk, fillingInputMemories, abcdeWriteAddress, mem_a_" + str(i) + "_writeData, abcdReadAddress_" + str(i) + ", mem_a_" + str(i) + "_readData);\n")
		file.write("\tassign array_a_" + str(i) + "_input = (validInputs_" + str(i) + ") ? mem_a_" + str(i) + "_readData:{inputBits{1'b0}};\n")
		file.write("\tassign mem_b_" + str(i) + "_writeData = S_AXIS_TDATA[" + str(1*arraySize+(i+1)) + "*inputBits-1:" + str(1*arraySize+i) + "*inputBits];\n")
		file.write("\tmem #(inputBits, arraySize) mem_b_" + str(i) + "(clk, fillingInputMemories, abcdeWriteAddress, mem_b_" + str(i) + "_writeData, abcdReadAddress_" + str(i) + ", mem_b_" + str(i) + "_readData);\n")
		file.write("\tassign array_b_" + str(i) + "_input = (validInputs_" + str(i) + ") ? mem_b_" + str(i) + "_readData:{inputBits{1'b0}};\n")
		file.write("\tassign mem_c_" + str(i) + "_writeData = S_AXIS_TDATA[" + str(2*arraySize+(i+1)) + "*inputBits-1:" + str(2*arraySize+i) + "*inputBits];\n")
		file.write("\tmem #(inputBits, arraySize) mem_c_" + str(i) + "(clk, fillingInputMemories, abcdeWriteAddress, mem_c_" + str(i) + "_writeData, abcdReadAddress_" + str(i) + ", mem_c_" + str(i) + "_readData);\n")
		file.write("\tassign array_c_" + str(i) + "_input = (validInputs_" + str(i) + ") ? mem_c_" + str(i) + "_readData:{inputBits{1'b0}};\n")
		file.write("\tassign mem_d_" + str(i) + "_writeData = S_AXIS_TDATA[" + str(3*arraySize+(i+1)) + "*inputBits-1:" + str(3*arraySize+i) + "*inputBits];\n")
		file.write("\tmem #(inputBits, arraySize) mem_d_" + str(i) + "(clk, fillingInputMemories, abcdeWriteAddress, mem_d_" + str(i) + "_writeData, abcdReadAddress_" + str(i) + ", mem_d_" + str(i) + "_readData);\n")
		file.write("\tassign array_d_" + str(i) + "_input = (validInputs_" + str(i) + ") ? mem_d_" + str(i) + "_readData:{inputBits{1'b0}};\n")
